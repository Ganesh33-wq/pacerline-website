...
export default function Blog() {
  const featuredPost = {
    ...
    content: 'Technology has become the backbone of modern property management...',
    author: 'Sarah Johnson',
    authorRole: 'Senior Property Management Consultant',
    authorImage: '/images/authors/sarah-johnson.jpg',
    publishDate: 'October 10, 2025',
    readTime: '8 min read',
    category: 'Property Management',
    image: '/images/blog/property-tech-featured.jpg',
